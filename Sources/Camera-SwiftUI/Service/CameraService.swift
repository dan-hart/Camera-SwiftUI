...
public class CameraService: NSObject, Identifiable {
    ...
    /// - Tag: ChangeCamera
    public func changeCamera(to preferredPositionOverride: AVCaptureDevice.Position?) {
        ...
        sessionQueue.async {
            ...
            if preferredPositionOverride != nil {
                preferredPosition = preferredPositionOverride!
            }
